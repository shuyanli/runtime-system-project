...
import (
	...
	"project/httpHandlerTest/stats"

	"github.com/varstr/uaparser"
)

const serviceName = "demo-app"
var _host = getHost() //cache
...
func getStatsTags(r *http.Request) map[string]string {
	...
	stats := map[string]string{
		...
		"host":		_host,   //cache by calling the function just once
	}

	//=========by caching this hostname, we can improve the performance of this function
